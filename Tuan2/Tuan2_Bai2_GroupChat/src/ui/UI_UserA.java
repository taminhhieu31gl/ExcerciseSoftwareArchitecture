...
public class UI_UserA implements ActionListener{
	TopicSubscriber subscriber;

	JFrame frame = new JFrame("Chat A");
	JButton btnSend = new JButton("Send");
	JTextArea output = new JTextArea();
	JTextArea input = new JTextArea();
	public UI_UserA() throws Exception {
		...
		subscriber = session.createSubscriber(topic,"",false);
